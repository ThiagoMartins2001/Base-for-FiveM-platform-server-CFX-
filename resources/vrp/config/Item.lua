...
--------------------------------------------------------------------------
	...
	["racertablet"] = {
		["Index"] = "racertablet",
		["Name"] = "Tablet de Corredor",
		["Description"] = "Tablet especial para corredores do CineRaces. Permite acessar rankings, eventos e criar perfil de corredor.",
		["Type"] = "Usável",
		["Weight"] = 0.5,
		['Block'] = true
	},
	["staffrace"] = {
		["Index"] = "staffrace",
		["Name"] = "Tablet de Administrador",
		["Description"] = "Tablet administrativo do CineRaces. Permite criar corridas, gerenciar eventos e administrar o sistema.",
		["Type"] = "Usável",
		["Weight"] = 0.5,
		['Block'] = true
	},
	["cineraces_credential"] = {
		["Index"] = "cineraces_credential",
		["Name"] = "Credencial de Corredor",
		["Description"] = "Credencial oficial do CineRaces que identifica o corredor no sistema.",
		["Type"] = "Comum",
		["Weight"] = 0.1,
		['Block'] = true
	},
	["cineraces_trophy_weekly"] = {
		["Index"] = "cineraces_trophy_weekly",
		["Name"] = "Troféu Semanal",
		["Description"] = "Troféu conquistado no ranking semanal do CineRaces.",
		["Type"] = "Comum",
		["Weight"] = 1.0,
		['Block'] = true
	},
	["cineraces_trophy_monthly"] = {
		["Index"] = "cineraces_trophy_monthly",
		["Name"] = "Troféu Mensal",
		["Description"] = "Troféu conquistado no ranking mensal do CineRaces.",
		["Type"] = "Comum",
		["Weight"] = 1.0,
		['Block'] = true
	},
	["cineraces_medal_weekly"] = {
		["Index"] = "cineraces_medal_weekly",
		["Name"] = "Medalha Semanal",
		["Description"] = "Medalha conquistada no ranking semanal do CineRaces.",
		["Type"] = "Comum",
		["Weight"] = 0.5,
		['Block'] = true
	},
	["cineraces_medal_monthly"] = {
		["Index"] = "cineraces_medal_monthly",
		["Name"] = "Medalha Mensal",
		["Description"] = "Medalha conquistada no ranking mensal do CineRaces.",
		["Type"] = "Comum",
		["Weight"] = 0.5,
		['Block'] = true
	},
