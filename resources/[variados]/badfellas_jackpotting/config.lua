...
Config.minPayment = 7000 --Valor mínimo de pagamento por roubo de ATM
Config.maxPayment = 9000 --Valor máximo de pagamento por roubo de ATM

Config.timeToRobbery = 28600 --Valor em segundos para roubar um ATM novamente
Config.percentPolice = 10 --Chance de chamar a polícia em um roubo
