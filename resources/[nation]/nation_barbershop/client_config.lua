...
local barberChairs = {
    [1] = {
        { coords = vec3(-34.98,-150.89,57.42), h = 65.31, offset = vec3(0.0, -0.6, -0.35) },
        { coords = vec3(-36.18,-154.19,57.44), h = 73.71,  offset = vec3(0.02, -0.6, -0.35) },
    },
    [2] = {
        { coords = vec3(1211.02,-474.88,66.56), h = 164.41, offset = vec3(-0.1, -0.6, -0.3) }, 
    ...
    [8] = {
        { coords = vec3(1248.24,-207.27,100.1), h = 0.0, offset = vec3(-0.02, -0.6, -0.35) },
        { coords = vec3(1248.24,-207.27,100.1), h = 0.0, offset = vec3(-0.02, -0.6, -0.35) },
    },
    [9] = {
