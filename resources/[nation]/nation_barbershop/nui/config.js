//const imgDir = "http://200.9.154.114/nation_barbershop/"; // DIRETÓRIO DAS IMAGENS
 //const imgDir = "https://paradisegroup.gg/malibu/nation_barbershop/"; // DIRETÓRIO DAS IMAGENS
  //const imgDir = "http://fivem.agudos.net:8080/nation_barbershop/"; 
// const imgDir ="http://104.234.65.51/ultimate/barbershop/";
 const imgDir = "http://127.0.0.1/nation_barbershop/";
const pt_BR = {
    back: "voltar",
    confirm: "confirmar",
    opacity: "opacidade",
