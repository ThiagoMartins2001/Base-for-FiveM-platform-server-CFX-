...
RegisterCommand("EmergencyFunctions",function()
	if (CheckPolice() or CheckCore() or CheckPRF() or CheckPCivil() or CheckParamedic()) and not IsPauseMenuActive() then
		...
		if CheckPolice() or CheckCore() or CheckPRF() or CheckPCivil() then
			...
			exports["dynamic"]:AddButton("Computador","Acessar MDT - Sistema de Polícia","mdt:open","",false,false)
		

			exports["dynamic"]:AddMenu("Emergência","Avisos emergenciais.","tencode")
			exports["dynamic"]:AddButton("10-4","Entendido.","dynamic:Tencode","4","tencode",true)
			exports["dynamic"]:AddButton("10-8","Em serviço.","dynamic:Tencode","8","tencode",true)
			exports["dynamic"]:AddButton("10-10","Em perseguição.","dynamic:Tencode","10","tencode",true)
			...
			exports["dynamic"]:AddButton("10-23","Cheguei ao local.","dynamic:Tencode","23","tencode",true)
			exports["dynamic"]:AddButton("10-38","Abordagem de trânsito.","dynamic:Tencode","38","tencode",true)
			exports["dynamic"]:AddButton("10-76","En route.","dynamic:Tencode","76","tencode",true)
			exports["dynamic"]:AddButton("10-77","ETA.","dynamic:Tencode","77","tencode",true)
			exports["dynamic"]:AddButton("10-78","Apoio com prioridade.","dynamic:Tencode","78","tencode",true)
			exports["dynamic"]:AddButton("10-97","Cheguei ao local.","dynamic:Tencode","97","tencode",true)
			...
			if Health > 100 and not IsPedInAnyVehicle(Ped) then
				...
				exports["dynamic"]:AddButton("CMD GERAL","Fardamento de comando geral.","player:Preset","5","prePolice",true)
				exports["dynamic"]:AddButton("GRAER","Fardamento de GRAER.","player:Preset","6","prePolice",true)
				exports["dynamic"]:AddButton("GRAER PRF","Fardamento de GRAER PRF.","player:Preset","7","prePolice",true)
				exports["dynamic"]:AddButton("GTM PRF","Fardamento de GTM PRF.","player:Preset","8","prePolice",true)
				exports["dynamic"]:AddButton("GTM","Fardamento de GTM.","player:Preset","9","prePolice",true)
				exports["dynamic"]:AddButton("SPEED","Fardamento de SPEED.","player:Preset","10","prePolice",true)
				exports["dynamic"]:AddButton("GRR","Fardamento de GRR.","player:Preset","11","prePolice",true)
